...
$consulta3 ="SELECT peliculas.* FROM peliculas_adquiridas INNER JOIN peliculas ON peliculas_adquiridas.id_pelicula = peliculas.id WHERE peliculas_adquiridas.usuario = '$usuario' and peliculas_adquiridas.fecha_expiracion is not NULL ORDER BY peliculas_adquiridas.fecha_compra DESC";
$result3 = $conn->query($consulta3);


$consulta4 ="SELECT peliculas.* FROM peliculas_adquiridas INNER JOIN peliculas ON peliculas_adquiridas.id_pelicula = peliculas.id WHERE peliculas_adquiridas.usuario = '$usuario' and peliculas_adquiridas.fecha_expiracion is NULL ORDER BY peliculas_adquiridas.fecha_compra DESC";
...
<body>
    ...
    <center><h1>TU BIBLIOTECA</h1></center>
    <h2>Películas adquiridas</h2>
    <table>
        <tr>
        <?php
        $counter = 0;
